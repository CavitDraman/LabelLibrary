...
Public Class XLabel
    ...
    Public Sub New()
        ...
        M_Label.EtiketSatırSayısı = 1
        M_Label.EtiketSutunSayısı = 1
        ...
        CreateItem("SUPPLIER PARTNO", LabelProject.LabelItem.ItemType.Text, 60, 30, 70, 20, "", "#SİPARİŞ ÜRÜN", "", LabelProject.LabelItem.BarcodeTypes.Code39, "", "", True, New Font("Arial", 9, FontStyle.Regular), ContentAlignment.TopLeft, Color.Black, 1)
        ...
        CreateItem("DELIVERY DATE", LabelProject.LabelItem.ItemType.Text, 122, 67, 22, 5, "", "@Bugün Tarihi", "", LabelProject.LabelItem.BarcodeTypes.Code39, "", "", True, New Font("Arial", 9, FontStyle.Regular), ContentAlignment.MiddleCenter, Color.Black, 1)
    End Sub
    Public Sub OnIzleme()
    ...
    Private Sub CreateItem(Name As String, ItmType As LabelProject.LabelItem.ItemType,
        ...
        With Item
            ...
            .BarkodVeriAlanı = BarkodVeriAlan
            .RefAlanListesi = RefAlanlist
            .BarcodeText = BarkodText
            If IsNothing(YazıTipi) Then
